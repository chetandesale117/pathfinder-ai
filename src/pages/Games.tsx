      ...
      <div className="flex items-start gap-4 mb-4">
        <div
          className={`p-3 rounded-xl bg-gradient-to-br ${
            isCompleted ? "from-primary/20 to-primary/10" : "from-muted to-muted/50"
          }`}
        >
          {icon}
        </div>
    ...
    <Layout>
      <div className="min-h-screen bg-background py-8 md:py-12">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">IQ & Knowledge Games</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Challenge yourself with engaging games designed to assess your cognitive abilities and help discover your
              ideal career path.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 rounded-2xl p-8 border border-border/50">
              ...
              <h2 className="text-xl font-bold text-foreground mb-2">Complete All Games to Unlock Career Quest</h2>
              <p className="text-muted-foreground mb-4 max-w-lg mx-auto">
                Finish all 5 assessment games to unlock the ultimate Career Quest Mode and receive your personalized
