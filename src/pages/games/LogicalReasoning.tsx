...
export default function LogicalReasoning() {
  ...
  const timePerQuestion = currentQ.difficulty === "Easy" ? 30 : currentQ.difficulty === "Medium" ? 25 : 20;
  ...
  const handleAnswer = (index: number) => {
    ...
    if (isCorrect) {
      ...
      toast({
        title: "Correct! 🎉",
        description: `+${points} points${streakBonus > 0 ? ` (${streakBonus} streak bonus!)` : ""}`,
      });
    } else {
      setStreak(0);
      toast({
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold text-foreground">Logical Reasoning</h1>
            </div>
          </div>
